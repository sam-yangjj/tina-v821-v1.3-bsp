...
char *drv_version   = XRADIO_VERSION GB_FLAG;
...
module_param_named(active, low_pwr_disable, byte, S_IRUGO);
MODULE_PARM_DESC(active, "Wi-Fi Keep Active (Default: 1)");
...
void xrmac_set_ioctl_ops(struct ieee80211_hw *hw, const struct ndo_do_ioctl_ops *ops);
#endif
...
#ifdef XRADIO_RAW_FRM_SUP
static const struct ndo_do_ioctl_ops xradio_ioctl_ops = {
	.set_rcv_special_frm	= xradio_ioctl_set_rcv_special_frm,
	.set_send_raw_frm_cfg	= xradio_ioctl_set_send_raw_frm_cfg,
	.set_sniff_auto_wakeup	= xradio_ioctl_set_sniff_auto_wakeup,
	.set_switch_ch_cfg		= xradio_ioctl_set_switch_ch_cfg,
	.get_cur_channel		= xradio_ioctl_get_cur_channel,
	.set_sniff_kp_active	= xradio_ioctl_set_sniff_kp_active,
	.set_frm_filter			= xradio_ioctl_set_frm_filter,
	.set_temp_frm			= xradio_ioctl_set_temp_frm,
	.send_sync_frm			= xradio_ioctl_send_sync_frm,
	.set_sniff_ext_param	= xradio_ioctl_set_sniff_ext_param,
	.get_rcv_stat			= xradio_ioctl_get_rcv_stat,
	.set_pm					= xradio_ioctl_set_pm,
};
...
struct ieee80211_hw *xradio_init_common(size_t hw_priv_data_len)
{
	...
	hw_priv = hw->priv;
#ifdef XRADIO_RAW_FRM_SUP
	xrmac_set_ioctl_ops(hw, &xradio_ioctl_ops);
	rx_spex_enable = 0;
#endif
