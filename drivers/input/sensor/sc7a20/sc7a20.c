...
#define sc7a20_MEASURING_RANGE_2G   0x88
#define sc7a20_MEASURING_RANGE_4G   0x98
#define sc7a20_MEASURING_RANGE_8G   0xa8
#define sc7a20_MEASURING_RANGE_16G  0xb8
...
static __maybe_unused void sc7a20_reset(void);
...
static void enable_sensor(int enable)
{
	...
	if (enable) {
		printk(KERN_INFO "%s: sc7a20_CTRL_PWRON 1\n", __func__);
		...
		printk(KERN_INFO "%s: sc7a20_CTRL_PWRDN 0\n", __func__);
		hrtimer_cancel(&sc7a20_data.hr_timer);
		cancel_work_sync(&sc7a20_data.wq_hrtimer);
