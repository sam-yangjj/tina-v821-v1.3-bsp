...
#ifndef _ICM42607_DEFS_H_
#define _ICM42607_DEFS_H_
...
#include "icm42607_regmap_rev_a.h"
#elif INV_IMU_REV == INV_IMU_REV_B
#include "icm42607_regmap_rev_b.h"
#endif
...
/*
 * SENSOR_CONFIG3_MREG1
 * Register Name: SENSOR_CONFIG3
 */
typedef enum {
	SENSOR_APEX_ENABLE  = (0 << SENSOR_CONFIG3_APEX_DISABLE_POS),
	SENSOR_APEX_DISABLE = (1 << SENSOR_CONFIG3_APEX_DISABLE_POS),
} SENSOR_APEX_CONFIG_t;
