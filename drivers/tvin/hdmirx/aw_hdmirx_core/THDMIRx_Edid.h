 ...
 */
#ifndef _THDMIRX_EDID_H_
#define _THDMIRx_EDID_H_
...
void HDMIRx_Edid_Dumpedid(uint8_t *p_edid, char *buf, ssize_t *lenth);
...
void HDMIRx_Edid_SetPullHotplug(U8 port_number, U8 type);
