...
static ssize_t volt_big_show(struct class *class, struct class_attribute *attr,
			 char *buf)
#else
static ssize_t volt_big_show(const struct class *class, const struct class_attribute *attr,
			 char *buf)
#endif
{
...
static ssize_t volt_big_store(struct class *class, struct class_attribute *attr,
			  const char *buf, size_t count)
#else
static ssize_t volt_big_store(const struct class *class, const struct class_attribute *attr,
			  const char *buf, size_t count)
#endif
{
	int volt;
...
static ssize_t freq_big_show(struct class *class, struct class_attribute *attr,
			 char *buf)
#else
static ssize_t freq_big_show(const struct class *class, const struct class_attribute *attr,
			 char *buf)
#endif
{
...
static ssize_t freq_big_store(struct class *class, struct class_attribute *attr,
			  const char *buf, size_t count)
#else
static ssize_t freq_big_store(const struct class *class, const struct class_attribute *attr,
			  const char *buf, size_t count)
#endif
{
