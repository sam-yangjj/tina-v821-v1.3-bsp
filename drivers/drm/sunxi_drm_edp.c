...
{
	struct sunxi_drm_edp *edp = (struct sunxi_drm_edp *)data;
	return general_panel_edp_is_support_backlight(edp->sdrm.panel);
}

static int sunxi_edp_get_backlight_value(void *data)
{
	struct sunxi_drm_edp *edp = (struct sunxi_drm_edp *)data;
	return general_panel_edp_get_backlight_value(edp->sdrm.panel);
}

static void sunxi_edp_set_backlight_value(void *data, int brightness)
{
	struct sunxi_drm_edp *edp = (struct sunxi_drm_edp *)data;
	general_panel_edp_set_backlight_value(edp->sdrm.panel, brightness);
}
