...
/* only enable iommu need unmap err debug? */
/* 821 self-write-back offline scenarios need to be defined */
#if !IS_ENABLED(CONFIG_AW_DISP2_DISABLE_FIFO_DEBUG) /* || IS_ENABLED(CONFIG_AW_IOMMU) */
...
#else
#define DECLARE_DEBUG	struct mgr_debug debug
#define mgr_debug_simple_add(disp, irq, tag) ((void)0)
static inline void *get_kfifo_ptr(int disp, bool irq) { return NULL; };
static inline int get_dmabuf_size(struct dmabuf_item *item) { return 0; };
static inline void debug_info_init(int disp, struct mgr_debug *debug, unsigned int line, const char *tag) {};
static inline void mgr_debug_info_put(int disp, struct mgr_debug *debug, bool irq) {};
static inline void mgr_debug_info_out_resize(int disp) {};
static inline void print_mgr_debug_info(int disp, bool irq) {};
...
#endif /* CONFIG_AW_DISP2_DISABLE_FIFO_DEBUG */
