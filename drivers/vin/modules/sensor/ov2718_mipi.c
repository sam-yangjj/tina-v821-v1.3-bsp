...
static struct regval_list sensor_1080phdr_2lane_regs[] = {
//	{0x3013, 0x01},
    {0x3013, 0x00},
    {0x3012, 0x01},
    {0x3000, 0x05},
...
static int sensor_s_hflip(struct v4l2_subdev *sd, int enable)
{
	...
	sensor_read(sd, 0x30C0, &get_value);
	...
	//usleep_range(10000,110000);
	do {
		/* write repeatly */
		sensor_write(sd, 0x30C0, set_value);
		sensor_write(sd, 0x30A9, reg_30a9);
		sensor_write(sd, 0x3252, reg_3252);
		eRet = sensor_read(sd, 0x30C0, &get_value);
...
static struct sensor_win_size sensor_win_sizes[] = {
	/* 1080P */
	{
		...
		.gain_min   = 1<<4,
		.gain_max   = 32<<4,
		.regs       = sensor_1080phdr_2lane_regs,
		.regs_size  = ARRAY_SIZE(sensor_1080phdr_2lane_regs),
		.set_size   = NULL,
	},
};
