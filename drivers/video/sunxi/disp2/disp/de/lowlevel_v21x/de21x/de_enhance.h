...
#define LTI_OFST  0x6800	/* LTI offset based on RTMX */
#define PEAK_OFST 0x6C00	/* PEAKING offset based on RTMX */

/* enahnce reg mem */
#if defined(DE_VERSION_V21X) && defined(CONFIG_ARCH_SUN55IW6)
#define DE_FCM_REG_MEM_SIZE (0x4000)
#define DE_DCI_REG_MEM_SIZE (0x0)
#define DE_SHARP_REG_MEM_SIZE (0x0)
#define DE_DEBAND_REG_MEM_SIZE (0x0)
#define DE_DITHER_REG_MEM_SIZE (0x1000)
#define DE_GAMMA_REG_MEM_SIZE (0x2000)
#define DE_LTI_REG_MEM_SIZE (0x0)
#define DE_PEAK_REG_MEM_SIZE (0x0)
...
#endif /* DE_VERSION_V21X && CONFIG_ARCH_SUN55IW6 */

#if IS_ENABLED(CONFIG_ARCH_SUN251IW1)
#define DE_FCM_REG_MEM_SIZE (0x0)
...
#define DE_ENHANCE_REG_MEM_SIZE \
	(DE_FCM_REG_MEM_SIZE + DE_DCI_REG_MEM_SIZE \
	 + DE_SHARP_REG_MEM_SIZE + DE_DEBAND_REG_MEM_SIZE \
	 + DE_DITHER_REG_MEM_SIZE + DE_GAMMA_REG_MEM_SIZE \
	 + DE_DLC_REG_MEM_SIZE + DE_LTI_REG_MEM_SIZE \
	 + DE_PEAK_REG_MEM_SIZE)
...
struct vep_config_info {
	u32 device_num;
	u32 vep_num[DE_NUM];
	u32 lti_exist[DE_NUM][VI_CHN_NUM];
	u32 peak_exist[DE_NUM][VI_CHN_NUM];
