...
enum disp_lcd_cpu_tri_mode {
	LCD_CPU_TRI_CNT = 0,
	LCD_CPU_TRI_FINISH = 1,
};
...
struct disp_panel_para {
	...
	unsigned int lcd_lvds_diff_amplifier_lv;
	...
	enum disp_lcd_cpu_tri_mode lcd_cpu_tri_mode;
	...
	unsigned int lcd_hv_sync_polarity;/* VSYNC HSYNC polar reverse */
	unsigned int lcd_hv_de_polarity;/* DE polar reverse */
	...
	unsigned int lvds_even_odd_dir;	/* lvds dual even and odd reverse */
};
...
struct disp_lcd_panel_fun {
	...
	int (*vsync_cmd)(unsigned int sel);
};
