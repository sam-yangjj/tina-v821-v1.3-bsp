...
#define SUNXI_DMA_MODULE_VERSION	"1.2.11"
/*
 * Common registers
 */
...
/*
 * The dma IP V3.2, like sun300iw1 sys dma etc., uses the number of dma channels from the
 * device tree node, same as v108, but not reset.
 */
static __maybe_unused struct sun6i_dma_config sunxi_dma_v112 = {
	.clock_autogate_enable = sun6i_enable_clock_autogate_h3,
	.set_burst_length = sun6i_set_burst_length_h3,
	.set_drq          = sun6i_set_drq_h6,
	.set_mode         = sun6i_set_mode_h6,
...
static const struct of_device_id sun6i_dma_match[] = {
	...
	{ .compatible = "allwinner,dma-v112", .data = &sunxi_dma_v112 },
	{ /* sentinel */ }
};
