				...
				struct v4l2_mbus_config *cfg)
{
	...
	if (info->isp_wdr_mode == ISP_DOL_WDR_MODE)
		cfg->bus.mipi_csi2.num_data_lanes = 0 | V4L2_MBUS_SUBLVDS_4_LANE | V4L2_MBUS_CSI2_CHANNEL_0 | V4L2_MBUS_CSI2_CHANNEL_1;
	else
		cfg->bus.mipi_csi2.num_data_lanes = 0 | V4L2_MBUS_SUBLVDS_4_LANE | V4L2_MBUS_CSI2_CHANNEL_0;
#else
	if (info->isp_wdr_mode == ISP_DOL_WDR_MODE)
