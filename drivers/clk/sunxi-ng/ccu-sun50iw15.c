...
#define SUN50IW15_PLL_DDR_CTRL_REG   0x0010
...
#define SUN50IW15_PLL_VIDEO1_CTRL_REG   0x0048
...
#define SUN50IW15_PLL_VIDEO2_CTRL_REG   0x0050
...
#define SUN50IW15_PLL_VIDEO3_CTRL_REG   0x0068
...
#define SUN50IW15_PLL_AUDIO0_REG		0x078
...
#define SUN50IW15_PLL_NPU_CTRL_REG   0x0080
...
#define SUN50IW15_USB0_CTRL_REG   0x0A70
...
#define SUN50IW15_USB1_CTRL_REG   0x0A74
...
/* for pm resume */
#define SUN50IW15_PLL_PERIPH1_PATTERN0_REG	0x128
...
static const u32 sun50iw15_pll_regs[] = {
	...
	SUN50IW15_PLL_VIDEO3_CTRL_REG,
	SUN50IW15_PLL_AUDIO0_REG,
	SUN50IW15_PLL_NPU_CTRL_REG,
};
...
static const u32 sun50iw15_usb_clk_regs[] = {
	SUN50IW15_USB0_CTRL_REG,
	SUN50IW15_USB1_CTRL_REG,
};
...
static int sun50iw15_ccu_probe(struct platform_device *pdev)
{
	 ...
	 */
	set_reg(reg + SUN50IW15_PLL_PERIPH1_PATTERN0_REG, 0xd1303333, 32, 0);
	set_reg(reg +SUN50IW15_PLL_PERI1_CTRL_REG, 1, 1, 24);
	...
	set_reg(reg + SUN50IW15_PLL_AUDIO0_REG, 0x1, 0, 0);

	for (i = 0; i < ARRAY_SIZE(sun50iw15_usb_clk_regs); i++) {
		set_reg(reg + sun50iw15_usb_clk_regs[i], 0x0, 2, 24);
	}
