...
static const int sun251iw1_de_supported_output_types[] = {
	DE_OUTPUT_TYPE_LCD,	/* TCON0 */
};

static const int sun251iw1_tcon_lcd_output_types[] = {
	/* TCON0 */
	TCON_TO_RGB | TCON_TO_LVDS | TCON_TO_SINGLE_DSI,
};

static const struct tcon_feat sun251iw1_de_features = {
	.num_devices = DEVICE_NUM,
	.num_dsi_devices = DEVICE_DSI_NUM,
	.supported_output_types = sun251iw1_de_supported_output_types,
	.tcon_output_types = sun251iw1_tcon_lcd_output_types,
};

static const struct tcon_feat *tcon_cur_features = &sun251iw1_de_features;
#endif
