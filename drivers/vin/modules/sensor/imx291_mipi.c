				...
				struct v4l2_mbus_config *cfg)
{
	...
	if (info->current_wins->width == HD1080_WIDTH &&
		...
		cfg->bus.mipi_csi2.num_data_lanes = V4L2_MBUS_CSI2_4_LANE | V4L2_MBUS_CSI2_CHANNEL_0;
	else
		cfg->bus.mipi_csi2.num_data_lanes = V4L2_MBUS_CSI2_2_LANE | V4L2_MBUS_CSI2_CHANNEL_0;
#else
	if (info->current_wins->width == HD1080_WIDTH &&
	    info->current_wins->height == HD1080_HEIGHT)
