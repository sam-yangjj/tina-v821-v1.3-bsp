...
__maybe_unused static struct regval_list sensor_1080p30wdr_regs[] = {
	/* 0x3288,0x50 tm */
	{0x0401, 0x3b},
	{0x0403, 0x00},
	{0x3180, 0x20},
...
__maybe_unused static struct regval_list sensor_1080p25wdr_regs[] = {
	/* 0x3288,0x50 tm */
	{0x0401, 0x3b},
	{0x0403, 0x00},
	{0x3180, 0x20},
...
__maybe_unused static int sensor_s_hflip(struct v4l2_subdev *sd, int enable)
{
	 data_type get_value;
...
__maybe_unused static int sensor_s_vflip(struct v4l2_subdev *sd, int enable)
{
	 data_type get_value;
	 data_type set_value = 0;
	 if (!(enable == 0 || enable == 1))
