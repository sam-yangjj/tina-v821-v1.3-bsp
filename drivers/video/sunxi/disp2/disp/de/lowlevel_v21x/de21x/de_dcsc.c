...
#if defined(USE_CSC2_COLOR_MATRIX)
	pq_enh[0] = _csc_enhance_setting_temp[enhance_mode][0];
	pq_enh[1] = _csc_enhance_setting_temp[enhance_mode][1];
	pq_enh[2] = _csc_enhance_setting_temp[enhance_mode][2];
	pq_enh[3] = _csc_enhance_setting_temp[enhance_mode][3];
#else
...
#if defined(USE_CSC2_COLOR_MATRIX)
	_csc_enhance_setting_temp[enhance_mode][0] = pq_enh[0];
	_csc_enhance_setting_temp[enhance_mode][1] = pq_enh[1];
	_csc_enhance_setting_temp[enhance_mode][2] = pq_enh[2];
	_csc_enhance_setting_temp[enhance_mode][3] = pq_enh[3];
#else
