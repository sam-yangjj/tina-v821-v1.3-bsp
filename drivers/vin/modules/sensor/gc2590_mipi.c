...
__maybe_unused static int sensor_g_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
	switch (ctrl->id) {
	case V4L2_CID_GAIN:
...
__maybe_unused static int sensor_s_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
{
