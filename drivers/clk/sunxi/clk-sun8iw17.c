...
#ifdef CONFIG_AW_FPGA_BOARD
	#define LOCKBIT(x) 31
#else
	#define LOCKBIT(x) x
#endif

#define RTC_CONTROL_REG_KEY   0x16AA0000
#define RTC_EXTERN_32K_ENABEL 0x1
...
static struct ccu_reset_map sun8iw17_ccu_resets[] = {
	[RST_MBUS_CFG]			= {MBUS_CFG, BIT(30)},
	[RST_DE_BGR]			= {DE_GATE,  BIT(16)},
	[RST_DI_BGR]			= {DI_GATE,  BIT(16)},
	[RST_G2D_BGR]			= {G2D_GATE, BIT(16)},
	[RST_EVE_BGR]			= {EVE_GATE, BIT(16)},
	[RST_GPU_BGR]			= {GPU_GATE, BIT(16)},
	[RST_CE_BGR]			= {CE_GATE,  BIT(16)},
	[RST_VE_BGR]			= {VE_GATE,  BIT(16)},
	[RST_DMA_BGR]			= {DMA_GATE, BIT(16)},
	[RST_MSGBOX_BGR]		= {MSGBOX_GATE, BIT(16)},
	[RST_SPINLOCK_BGR]		= {SPINLOCK_GATE, BIT(16)},
	[RST_HSTIMER_BGR]		= {HSTIMER_GATE, BIT(16)},
	[RST_DBGSYS_BGR]		= {DBGSYS_GATE, BIT(16)},
	[RST_PSI_BGR]			= {PSI_GATE,  BIT(16)},
	[RST_PWM_BGR]			= {PWM_GATE,  BIT(16)},
	[RST_DRAM_BGR]			= {DRAM_GATE, BIT(16)},
	[RST_NAND_BGR]			= {NAND_GATE, BIT(16)},
	[RST_SMHC3]				= {SMHC_GATE, BIT(19)},
	[RST_SMHC2]				= {SMHC_GATE, BIT(18)},
	[RST_SMHC1]				= {SMHC_GATE, BIT(17)},
	[RST_SMHC0]				= {SMHC_GATE, BIT(16)},
	[RST_UART4]				= {UART_GATE, BIT(20)},
	[RST_UART3]				= {UART_GATE, BIT(19)},
	[RST_UART2]				= {UART_GATE, BIT(18)},
	[RST_UART1]				= {UART_GATE, BIT(17)},
	[RST_UART0]				= {UART_GATE, BIT(16)},
	[RST_TWI6]				= {TWI_GATE,  BIT(22)},
	[RST_TWI5]				= {TWI_GATE,  BIT(21)},
	[RST_TWI4]				= {TWI_GATE,  BIT(20)},
	[RST_TWI3]				= {TWI_GATE,  BIT(19)},
	[RST_TWI2]				= {TWI_GATE,  BIT(18)},
	[RST_TWI1]				= {TWI_GATE,  BIT(17)},
	[RST_TWI0]				= {TWI_GATE,  BIT(16)},
	[RST_SCR_BGR]			= {SCR_GATE,  BIT(16)},
	[RST_SPI1]				= {SPI_GATE,  BIT(17)},
	[RST_SPI0]				= {SPI_GATE,  BIT(16)},
	[RST_GMAC_BGR]			= {GMAC_GATE, BIT(16)},
	[RST_TS_BGR]			= {TS_GATE,   BIT(16)},
	[RST_GPADC_BGR]			= {GPADC_GATE, BIT(16)},
	[RST_I2S_PCM_2]		    = {I2S_GATE,  BIT(18)},
	[RST_I2S_PCM_1]		    = {I2S_GATE,  BIT(17)},
	[RST_I2S_PCM_0]		    = {I2S_GATE,  BIT(16)},
	[RST_S_PDIF]			= {SPDIF_GATE, BIT(16)},
	[RST_DMIC]				= {DMIC_GATE,  BIT(16)},
	[RST_AUDIO_CODEC]		= {CODEC_GATE, BIT(16)},
	[RST_USBPHY0]			= {USB0_CFG,   BIT(30)},
	[RST_USBPHY1]			= {USB1_CFG,   BIT(30)},
	[RST_USBPHY2]			= {USB2_CFG,   BIT(30)},
	[RST_USBPHY3]			= {USB3_CFG,   BIT(30)},
	[RST_USB_OTG]			= {USB_GATE,   BIT(24)},
	[RST_USB_EHCI3]			= {USB_GATE,   BIT(23)},
	[RST_USB_EHCI2]			= {USB_GATE,   BIT(22)},
	[RST_USB_EHCI1]			= {USB_GATE,   BIT(21)},
	[RST_USB_EHCI0]			= {USB_GATE,   BIT(20)},
	[RST_USB_OHCI3]			= {USB_GATE,   BIT(19)},
	[RST_USB_OHCI2]			= {USB_GATE,   BIT(18)},
	[RST_USB_OHCI1]			= {USB_GATE,   BIT(17)},
	[RST_USB_OHCI0]			= {USB_GATE,   BIT(16)},
	[RST_MIPI]				= {MIPI_GATE,  BIT(16)},
	[RST_DISPLAY_IF_TOP]	= {DISPLAY_TOP_GATE, BIT(16)},
	[RST_TCON_LCD1]			= {TCON_LCD_GATE, BIT(17)},
	[RST_TCON_LCD0]			= {TCON_LCD_GATE, BIT(16)},
	[RST_TCON_TV]			= {TCON_TV_GATE,  BIT(16)},
	[RTS_LVDS]				= {LVDS_GATE,     BIT(16)},
	[RST_TVD3]				= {TVD_GATE,   BIT(20)},
	[RST_TVD2]				= {TVD_GATE,   BIT(19)},
	[RST_TVD1]				= {TVD_GATE,   BIT(18)},
	[RST_TVD0]				= {TVD_GATE,   BIT(17)},
	[RST_TVD_TOP]			= {TVD_GATE,   BIT(16)},
	[RST_CSI]				= {CSI_GATE,   BIT(16)}
};

static struct ccu_reset_map sun8iw17_r_ccu_resets[] = {
	[RST_R_TIMER]			= {CPUS_TIMER_GATE, BIT(16)},
	[RST_R_TWDOG]			= {CPUS_TWDOG_GATE, BIT(16)},
	[RST_R_PWM]				= {CPUS_PWM_GATE,   BIT(16)},
	[RST_R_VM]				= {CPUS_VM_GATE,    BIT(16)},
	[RST_R_THS]				= {CPUS_THS_GATE,	BIT(16)},
	[RST_R_LRADC]			= {CPUS_LRADC_GATE, BIT(16)},
	[RST_R_UART4]			= {CPUS_UART_GATE,  BIT(20)},
	[RST_R_UART3]			= {CPUS_UART_GATE,  BIT(19)},
	[RST_R_UART2]			= {CPUS_UART_GATE,  BIT(18)},
	[RST_R_UART1]			= {CPUS_UART_GATE,  BIT(17)},
	[RST_R_UART0]			= {CPUS_UART_GATE,  BIT(16)},
	[RST_R_TWI2]			= {CPUS_TWI_GATE,   BIT(18)},
	[RST_R_TWI1]			= {CPUS_TWI_GATE,   BIT(17)},
	[RST_R_TWI0]			= {CPUS_TWI_GATE,   BIT(16)},
	[RST_R_RSB]				= {CPUS_RSB_GATE,   BIT(16)},
	[RST_R_CIR]				= {CPUS_CIR_GATE,   BIT(16)},
	[RST_R_SPI]				= {CPUS_SPI_GATE,   BIT(16)}
};
/*
...
static int sunxi_reset_register(struct device_node *node, const char *clk, struct ccu_reset_map *reset_map, int reset_num)
{
	...
	clk_node = of_find_node_by_name(node, clk);
	...
	reset->rcdev.of_node = clk_node;
	reset->rcdev.ops = &ccu_reset_ops;
	reset->rcdev.owner = THIS_MODULE;
	reset->rcdev.nr_resets = reset_num;
	reset->base = clk_base;
	reset->lock = &clk_lock;
	reset->reset_map = reset_map;

	ret = reset_controller_register(&reset->rcdev);
	if (ret)
		goto err_reset_kzalloc;
...
void sunxi_clocks_init(struct device_node *node)
{
	...
	if (rtc_clk_base) {
		reg_val = readl(sunxi_clk_base);
		reg_val |= (RTC_CONTROL_REG_KEY | RTC_EXTERN_32K_ENABEL);
		writel(reg_val, sunxi_clk_base);
	}

	ret = sunxi_reset_register(node, "ccu", sun8iw17_ccu_resets, ARRAY_SIZE(sun8iw17_ccu_resets));
	if (ret)
		pr_err("reset ccu register error\n");

	ret = sunxi_reset_register(node, "r_ccu", sun8iw17_r_ccu_resets, ARRAY_SIZE(sun8iw17_r_ccu_resets));
	if (ret)
		pr_err("reset r_ccu register error\n");
}
