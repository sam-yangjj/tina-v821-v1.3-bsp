 ...
 */
#ifndef __MS7200_REGS_H_
#define __MS7200_REGS_H_
...
void ms_write8_mask(struct v4l2_subdev *sd, u16 reg, u8 mask, u8 val);
void ms_write16_mask(struct v4l2_subdev *sd, u16 reg, u16 mask, u16 val);
void ms_write32_mask(struct v4l2_subdev *sd, u16 reg, u32 mask, u32 val);
void ms_write16_mask_not_filp(struct v4l2_subdev *sd, u16 reg, u16 mask, u16 val);
void ms_write32_mask_not_filp(struct v4l2_subdev *sd, u16 reg, u32 mask, u32 val);
#endif
