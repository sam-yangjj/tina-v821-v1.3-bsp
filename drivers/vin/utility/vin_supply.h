...
extern int vin_gpio_to_irq(struct v4l2_subdev *sd, enum gpio_type gpio_id, int *gpio_irq);
extern int vin_gpio_to_mipisw(struct v4l2_subdev *sd, enum gpio_type gpio_id);
