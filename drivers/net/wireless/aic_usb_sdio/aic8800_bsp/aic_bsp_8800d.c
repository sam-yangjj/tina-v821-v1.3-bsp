...
static const struct aicbsp_firmware fw_u02[] = {
	[AICBSP_CPMODE_WORK] = {
		...
		.bt_adid       = "sdio/fw_adid.bin",
		.bt_patch      = "sdio/fw_patch.bin",
		.bt_table      = "sdio/fw_patch_table.bin",
		.wl_fw         = "sdio/fmacfw.bin",
		.wl_table      = "sdio/fmacfw_patch.bin"
	},
...
static const struct aicbsp_firmware fw_u03[] = {
	[AICBSP_CPMODE_WORK] = {
		...
		.bt_adid       = "sdio/fw_adid_u03.bin",
		.bt_patch      = "sdio/fw_patch_u03.bin",
		.bt_table      = "sdio/fw_patch_table_u03.bin",
		.wl_fw         = "sdio/fmacfw.bin",
		.wl_table      = "sdio/fmacfw_patch.bin"
	},
...
static const struct aicbsp_firmware fw_u02[] = {
	[AICBSP_CPMODE_WORK] = {
		...
		.bt_adid       = "usb/fw_adid.bin",
		.bt_patch      = "usb/fw_patch.bin",
		.bt_table      = "usb/fw_patch_table.bin",
		.wl_fw         = "usb/fmacfw.bin"
	},
...
static const struct aicbsp_firmware fw_u03[] = {
	[AICBSP_CPMODE_WORK] = {
		...
		.bt_adid       = "usb/fw_adid_u03.bin",
		.bt_patch      = "usb/fw_patch_u03.bin",
		.bt_table      = "usb/fw_patch_table_u03.bin",
		.wl_fw         = "usb/fmacfw.bin"
	},
