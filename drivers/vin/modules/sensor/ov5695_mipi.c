 ...
 * framelength 2024(0x07e8) //1012(0x03f4)
 * grabwindow_width 1280 //1296
 * grabwindow_height 960 //972
 * max_framerate 30fps //60fps
 * mipi_datarate per lane 840Mbps
 */
static struct regval_list sensor_960p_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x0300, 0x04},
	{0x0301, 0x00},
	...
	{0x3807, 0xaf},
	{0x3808, 0x05},
	{0x3809, 0x00},//0x0500 = 1280, 0x0510 = 1296
	{0x380a, 0x03},
	{0x380b, 0xc0},//0x03c0 = 960, 0x03cc = 972
	{0x380c, 0x02},
	{0x380d, 0xe4},
	{0x380e, 0x07}, //
	{0x380f, 0xe8}, //0x07e8 = 30fps, 0x03f4 = 60fps
	{0x3810, 0x00},
	{0x3811, 0x00},
	{0x3812, 0x00},
	{0x3813, 0x06},
...
static struct sensor_win_size sensor_win_sizes[] = {
    ...
    },
    {
	  ...
	  .gain_min   = 1<<4,
	  .gain_max   = 64<<4,
	  .regs       = sensor_960p_regs,
	  .regs_size  = ARRAY_SIZE(sensor_960p_regs),
		.set_size   = NULL,
    },
};
