...
#define WSM_TXC_F_IS_RAW_FRM		(BIT(7))
...
#define WSM_RX_STATUS_DUPLICATE_FRAME	(BIT(28))
#define WSM_RX_STATUS_RECV_FILTER_FRAME	(BIT(30))
#endif
...
#define WSM_TX_SEND_RAW_FRAME    (BIT(0))
...
#define WSM_MIB_ID_GUBEI_RECV_SPEC_FRAME        0x1081  /* set enable receive special frame in STA mode */
#define WSM_MIB_ID_GUBEI_SET_PHY_MODE_CFG       0x108B

#define WSM_MIB_ID_GUBEI_SEND_RAW_FRAME         0x1082  /* set enable send raw frame & rcv ack in STA mode */
#define WSM_MIB_ID_GUBEI_SNIFF_AUTO_WAKEUP      0x1083

#define WSM_MIB_ID_RX_FRAME_FILTER_CFG          0x1084
#define WSM_MIB_ID_GUBEI_SWITCH_CHANNEL         0x1085
#define WSM_MIB_ID_GUBEI_GET_CHANNEL            0x1086
#define WSM_MIB_ID_GUBEI_SNIFF_KEEP_ACTIVE      0x1087
#define WSM_MIB_ID_FRAME_FILTER_SET             0x1088
#define WSM_MIB_ID_GUBEI_SEND_SYNC_FRM          0x1089
#define WSM_MIB_ID_GUBEI_FUNC_PARAM_EXTERN      0x1094
#define WSM_MIB_ID_GUBEI_GET_RECEIVE_STAT       0x1095
