...
#define RTWB_USE_RCQ (2) /* 2 mean wb use de rcq */
#define WB_HAS_CSC
#define SUPPORT_RTWB

#define DE_RTWB_NUM (1)
#define GLB_MAX_CDC_NUM (0)
...
// #define SUPPORT_SMBL
// #endif
#endif /* CONFIG_AW_DISP2_SUPPORT_SMBL */
...
#define SUPPORT_PQ
#define SUPPORT_CRC
#define SUPPORT_SHARP_RGB_PQ (0)
#define ONLY_SUPPORT_DCI_FDT (0)
#endif /* CONFIG_ARCH_SUN55IW6 */
...
#define ONLY_SUPPORT_DCI_FDT (1)
#define USE_CSC2_COLOR_MATRIX
#endif /* CONFIG_ARCH_SUN251IW1 */
...
struct de_feat {
	...
	const s32 *num_csc2_chns;
	const s32 *num_csc2_disps;
	...
	const s32 *is_support_lti;
	const s32 *is_support_peak;
