...
static const unsigned int sun8iw17p1_irq_bank_map[] = {
...
static const struct sunxi_pinctrl_desc sun8iw17p1_pinctrl_data = {
	...
	.irq_banks = ARRAY_SIZE(sun8iw17p1_irq_bank_map),
	.irq_bank_map = sun8iw17p1_irq_bank_map,
	.pin_base = 0,
...
{
	return sunxi_bsp_pinctrl_init(pdev, &sun8iw17p1_pinctrl_data);
}
