...
/* Describe which bank use vcc-op */
static const unsigned int sun8iw20_vccio_banks[] = {
	SUNXI_BANK_OFFSET('B', 'A'),
};

static const unsigned int sun8iw20_bank_base[] = {
	SUNXI_BANK_OFFSET('B', 'A'),
	SUNXI_BANK_OFFSET('C', 'A'),
	SUNXI_BANK_OFFSET('D', 'A'),
	SUNXI_BANK_OFFSET('E', 'A'),
...
static const struct sunxi_pinctrl_desc sun8iw20_pinctrl_data = {
	...
	.vccio_banks = sun8iw20_vccio_banks,
	.vccio_nbanks = ARRAY_SIZE(sun8iw20_vccio_banks),
	.io_bias_cfg_variant = BIAS_VOLTAGE_PIO_POW_MODE_CTL_V2,
	.pf_power_source_switch = true,
	.hw_type = SUNXI_PCTL_HW_TYPE_9,
};
