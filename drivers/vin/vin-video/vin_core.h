...
struct vin_core {
	...
	unsigned char use_one_buffer;
	unsigned char frame_use_flag;
	...
	struct work_struct set_sensor_expgain_task;
	bool jpg_vbv_share_yuv_en;
	int jpg_vbv_expand_head_bytes;
