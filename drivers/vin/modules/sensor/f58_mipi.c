...
MODULE_AUTHOR("hzh");
MODULE_DESCRIPTION("A low-level driver for f58 sensors");
MODULE_LICENSE("GPL");
...
#define SENSOR_NAME "f58_mipi"
#define SENSOR_NAME_2 "f58_mipi_2"
...
{
	struct sensor_info *info = to_state(sd);
	//	printk("f58 sensor gain value is %d\n",gain_val);
...

{
	...
	shutter = exp_val >> 4;
	if (shutter > f58_sensor_vts - 4)
		frame_length = shutter + 4;
	else
		frame_length = f58_sensor_vts;
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
	...
	printk("------------------------\r\n");
	printk("this is f58 sensor init\r\n");
	printk("------------------------\r\n");
	printk("**********************************\r\n");
	printk("***********sensor init************\r\n");
	printk("**********************************\r\n");
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	f58_sensor_vts = wsize->vts;
	sensor_dbg("f58_sensor_vts = %d\n", f58_sensor_vts);
