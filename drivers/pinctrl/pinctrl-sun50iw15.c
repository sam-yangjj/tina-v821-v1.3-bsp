...
static const struct sunxi_desc_pin sun50iw15_pins[] = {
...
/* Pin banks are: A B C D F G */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(B, 9),
		...
		SUNXI_FUNCTION(0x5, "i2s0"),		/* i2s0_din2 */
		SUNXI_FUNCTION(0x6, "i2s0"),		/* i2s0_dout2 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(B, 10),
		...
		SUNXI_FUNCTION(0x5, "i2s0"),		/* i2s0_din3 */
		SUNXI_FUNCTION(0x6, "i2s0"),		/* i2s0_dout3 */
		SUNXI_FUNCTION_IRQ_BANK(0xe, 0, 10),	/* eint */
		SUNXI_FUNCTION(0xf, "io_disabled")),	/* io_disabled */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 12),
		...
		SUNXI_FUNCTION(0x5, "pwm12"),		/* pwm12 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 13),
		...
		SUNXI_FUNCTION(0x5, "pwm13"),		/* pwm13 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 14),
		...
		SUNXI_FUNCTION(0x5, "pwm14"),		/* pwm14 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 15),
		...
		SUNXI_FUNCTION(0x5, "pwm15"),		/* pwm15 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 16),
		...
		SUNXI_FUNCTION(0x5, "pwm16"),		/* pwm16 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 17),
		...
		SUNXI_FUNCTION(0x5, "pwm17"),		/* pwm17 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 18),
		...
		SUNXI_FUNCTION(0x5, "pwm18"),		/* pwm18 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(D, 19),
		...
		SUNXI_FUNCTION(0x5, "pwm19"),		/* pwm19 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 0),
		...
		SUNXI_FUNCTION(0x4, "trace"),		/* trace_data2 */
		SUNXI_FUNCTION(0x5, "i2s3"),		/* i2s3_din0 */
		SUNXI_FUNCTION(0x6, "i2s3"),		/* i2s3_dout1 */
		SUNXI_FUNCTION_IRQ_BANK(0xe, 4, 0),	/* eint */
		SUNXI_FUNCTION(0xf, "io_disabled")),	/* io_disabled */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 1),
		...
		SUNXI_FUNCTION(0x4, "trace"),		/* trace_data1 */
		SUNXI_FUNCTION(0x5, "i2s3"),		/* i2s3_dout0 */
		SUNXI_FUNCTION(0x6, "i2s3"),		/* i2s3_din1 */
		SUNXI_FUNCTION_IRQ_BANK(0xe, 4, 1),	/* eint */
		SUNXI_FUNCTION(0xf, "io_disabled")),	/* io_disabled */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 2),
		...
		SUNXI_FUNCTION(0x5, "i2s3"),		/* i2s3_din2 */
		SUNXI_FUNCTION(0x6, "i2s3"),		/* i2s3_dout2 */
		SUNXI_FUNCTION_IRQ_BANK(0xe, 4, 2),	/* eint */
		SUNXI_FUNCTION(0xf, "io_disabled")),	/* io_disabled */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 4),
		...
		SUNXI_FUNCTION(0x5, "i2s3"),		/* i2s3_din3 */
		SUNXI_FUNCTION(0x6, "i2s3"),		/* i2s3_dout3 */
		SUNXI_FUNCTION_IRQ_BANK(0xe, 4, 4),	/* eint */
		SUNXI_FUNCTION(0xf, "io_disabled")),	/* io_disabled */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 14),
		...
		SUNXI_FUNCTION(0x4, "i2s1"),		/* i2s1_dout1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 2),
		...
		SUNXI_FUNCTION(0x4, "i2s2"),		/* i2s2_din3 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 3),
		...
		SUNXI_FUNCTION(0x4, "i2s2"),		/* i2s2_din2 */
		SUNXI_FUNCTION(0x5, "gmac0"),		/* rgmmii0_clkin/rmii0_rxer */
		SUNXI_FUNCTION(0x6, "i2s2"),		/* i2s2_dout2 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 6),
		...
		SUNXI_FUNCTION(0x4, "spdif"),		/* spdif_in */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 7),
		...
		SUNXI_FUNCTION(0x4, "spdif"),		/* spdif_out */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 8),
		...
		SUNXI_FUNCTION(0x3, "spi2"),		/* spi2_cs */
		SUNXI_FUNCTION(0x4, "i2s2"),		/* i2s2_mclk */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s2_din2 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 11),
		...
		SUNXI_FUNCTION(0x3, "spi2"),		/* spi2_miso */
		SUNXI_FUNCTION(0x4, "i2s2"),		/* i2s2_dout0 */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s2_din1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 12),
		...
		SUNXI_FUNCTION(0x4, "i2s2"),		/* i2s2_din0 */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s2_dout1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 16),
		SUNXI_FUNCTION(0x0, "gpio_in"),		/* gpio_in */
		SUNXI_FUNCTION(0x1, "gpio_out"),	/* gpio_out */
		SUNXI_FUNCTION(0x3, "i2s3"),		/* i2s3_dout0 */
		SUNXI_FUNCTION(0x4, "i2s3"),		/* i2s3_din1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 17),
		SUNXI_FUNCTION(0x0, "gpio_in"),		/* gpio_in */
		SUNXI_FUNCTION(0x1, "gpio_out"),	/* gpio_out */
		SUNXI_FUNCTION(0x3, "i2s3"),		/* i2s3_dout1 */
		SUNXI_FUNCTION(0x4, "i2s3"),		/* i2s3_din0 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 18),
		...
		SUNXI_FUNCTION(0x3, "i2s3"),		/* i2s3_dout2 */
		SUNXI_FUNCTION(0x4, "i2s3"),		/* i2s3_din2 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 0),
		...
		SUNXI_FUNCTION(0x3, "uart4"),		/* uart4_tx */
		SUNXI_FUNCTION(0x4, "pwm1"),		/* pwm1 */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s3_din3 */
		SUNXI_FUNCTION(0x6, "i2s2"),		/* i2s2_dout3 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 1),
		...
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s3_din2 */
		SUNXI_FUNCTION(0x6, "i2s2"),		/* i2s2_dout2 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 4),
		...
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s2_dout0 */
		SUNXI_FUNCTION(0x6, "i2s2"),		/* i2s2_din1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 5),
		...
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s2_din0 */
		SUNXI_FUNCTION(0x6, "i2s2"),		/* i2s2_dout1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 9),
		...
		SUNXI_FUNCTION(0x4, "pwm10"),		/* pwm10 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 10),
		SUNXI_FUNCTION(0x0, "gpio_in"),		/* gpio_in */
		SUNXI_FUNCTION(0x1, "gpio_out"),	/* gpio_out */
		SUNXI_FUNCTION(0x2, "spdif"),		/* spdif_out */
		SUNXI_FUNCTION(0x3, "dmic"),		/* dmic_data1 */
		SUNXI_FUNCTION(0x4, "pwm11"),		/* pwm11 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 11),
		...
		SUNXI_FUNCTION(0x4, "pwm12"),		/* pwm12 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 12),
		...
		SUNXI_FUNCTION(0x1, "gpio_out"),	/* gpio_out */
		SUNXI_FUNCTION(0x2, "uart3"),		/* uart3_rx */
		SUNXI_FUNCTION(0x4, "pwm13"),		/* pwm13 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 13),
		...
		SUNXI_FUNCTION(0x4, "pwm14"),		/* pwm14 */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* i2s2_mclk */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 14),
		...
		SUNXI_FUNCTION(0x4, "pwm15"),		/* pwm15 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 15),
		...
		SUNXI_FUNCTION(0x4, "pwm16"),		/* pwm16 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(I, 16),
		...
		SUNXI_FUNCTION(0x4, "pwm17"),		/* pwm17 */
...
static const unsigned int sun50iw15_irq_bank_map[] = {
...
static const struct sunxi_pinctrl_desc sun50iw15_pinctrl_data = {
	.pins = sun50iw15_pins,
	.npins = ARRAY_SIZE(sun50iw15_pins),
	.irq_banks = ARRAY_SIZE(sun50iw15_irq_bank_map),
	.irq_bank_map = sun50iw15_irq_bank_map,
...
static int sun50iw15_pinctrl_suspend_noirq(struct device *dev)
{
...
static int sun50iw15_pinctrl_resume_noirq(struct device *dev)
{
	struct sunxi_pinctrl *pctl = dev_get_drvdata(dev);
	unsigned long flags;
...
static const struct dev_pm_ops sun50iw15_pinctrl_pm_ops = {
	.suspend_noirq = sun50iw15_pinctrl_suspend_noirq,
	.resume_noirq = sun50iw15_pinctrl_resume_noirq,
};
#define PINCTRL_PM_OPS	(&sun50iw15_pinctrl_pm_ops)
...
static int sun50iw15_pinctrl_probe(struct platform_device *pdev)
{
	int ret;
...
#endif
	return sunxi_bsp_pinctrl_init(pdev, &sun50iw15_pinctrl_data);
}

static struct of_device_id sun50iw15_pinctrl_match[] = {
	{ .compatible = "allwinner,sun50iw15-pinctrl", },
	{}
};

MODULE_DEVICE_TABLE(of, sun50iw15_pinctrl_match);

static struct platform_driver sun50iw15_pinctrl_driver = {
	.probe	= sun50iw15_pinctrl_probe,
	.driver	= {
		.name		= "sun50iw15-pinctrl",
		.pm		= PINCTRL_PM_OPS,
		.of_match_table	= sun50iw15_pinctrl_match,
	},
};

static int __init sun50iw15_pio_init(void)
{
	return platform_driver_register(&sun50iw15_pinctrl_driver);
}
fs_initcall(sun50iw15_pio_init);

MODULE_DESCRIPTION("Allwinner sun50iw15 pio pinctrl driver");
