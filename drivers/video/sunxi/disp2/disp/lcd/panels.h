...
#endif
#if IS_ENABLED(CONFIG_LCD_SUPPORT_C400AFH032)
extern struct __lcd_panel C400AFH032_panel;
#endif
#if IS_ENABLED(CONFIG_LCD_SUPPORT_NV3049F)
extern struct __lcd_panel nv3049f_panel;
#endif
