...
// static int sensor_s_hvflip(struct v4l2_subdev *sd, int enable)
// {
// 	data_type get_value;
// 	data_type set_value;
...
// 	sensor_read(sd, 0x12, &get_value);
// 	//printk("--sensor hvfilp set[%d] read value:0x%X --\n", enable, get_value);
// 	if (enable)
// 		set_value = get_value | 0x30;
// 	else
// 		set_value = get_value & 0xCF;

// 	//printk("--set sensor hvfilp the value:0x%X --\n", set_value);
// 	sensor_write(sd, 0x12, set_value);
// 	return 0;
// }
...
//		ret = sensor_s_fps(sd, (struct sensor_fps *)arg);
	...
	case VIDIOC_VIN_SENSOR_GET_FPS:
		sensor_g_fps(sd, (struct sensor_fps *)arg);
		break;
...
static int sensor_s_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	// case V4L2_CID_HVFLIP:
	// 	return sensor_s_hvflip(sd, ctrl->val);
	}
	return -EINVAL;
}
...
static int sensor_init_controls(struct v4l2_subdev *sd, const struct v4l2_ctrl_ops *ops)
{
	...
	// v4l2_ctrl_new_std(handler, ops, V4L2_CID_HVFLIP, 0, 1, 1, 0);
