				...
				struct v4l2_mbus_config *cfg)
{
	...
	if (info->current_wins->width_input == 1920 && info->current_wins->height_input == 1080)
		cfg->bus.mipi_csi2.num_data_lanes = V4L2_MBUS_CSI2_4_LANE | V4L2_MBUS_CSI2_CHANNEL_0 | V4L2_MBUS_CSI2_CHANNEL_1 ;
	else
		cfg->bus.mipi_csi2.num_data_lanes = V4L2_MBUS_CSI2_4_LANE | V4L2_MBUS_CSI2_CHANNEL_0 | V4L2_MBUS_CSI2_CHANNEL_1 | V4L2_MBUS_CSI2_CHANNEL_2 | V4L2_MBUS_CSI2_CHANNEL_3;
#else
	if (info->current_wins->width_input == 1920 && info->current_wins->height_input == 1080)
