...
static const unsigned int sun8iw17p1_r_irq_bank_map[] = {
...
static const struct sunxi_pinctrl_desc sun8iw17p1_r_pinctrl_data = {
	...
	.irq_banks = ARRAY_SIZE(sun8iw17p1_r_irq_bank_map),
	.irq_bank_map = sun8iw17p1_r_irq_bank_map,
	.pin_base = SUNXI_PIN_BASE('L'),
	.pf_power_source_switch = false,
	.hw_type = SUNXI_PCTL_HW_TYPE_0,
	.io_bias_cfg_variant = BIAS_VOLTAGE_NONE,
};

static int sun8iw17p1_r_pinctrl_probe(struct platform_device *pdev)
{
	return sunxi_bsp_pinctrl_init(pdev, &sun8iw17p1_r_pinctrl_data);
}
