...
#ifdef XRADIO_RAW_FRM_SUP
enum xradio_tx_raw_state {
	SDATA_RAW_TX_STATE_SUCCESS = 0,
	SDATA_RAW_TX_STATE_FAILED,
	SDATA_RAW_TX_STATE_TXING,
	SDATA_RAW_TX_STATE_TXED,
	SDATA_RAW_TX_STATE_LAST,
	SDATA_RAW_TX_STATE_MAX = SDATA_RAW_TX_STATE_LAST - 1,
};

enum xradio_raw_tx_mode {
	SDATA_RAW_TX_MODE_NORMAL = 0,
	SDATA_RAW_TX_MODE_BLOCKING,
};
#endif
...
#ifdef XRADIO_RAW_FRM_SUP
	struct semaphore tx_raw_lock;
	wait_queue_head_t tx_raw_wq;
	enum xradio_tx_raw_state raw_state;
	u8 raw_tx_mode;
	unsigned long raw_tx_timeout;
#endif
...
#ifdef XRADIO_RAW_FRM_SUP
	const struct ndo_do_ioctl_ops *ioctl_ops;
#endif
