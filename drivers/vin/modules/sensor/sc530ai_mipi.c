...
static struct regval_list sensor_2880x1620_15fps_2lan_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct regval_list sensor_2880x1620_30fps_4lan_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct regval_list sensor_2880x1620_20fps_4lan_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct regval_list sensor_2880x1620_60fps_4lane_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct regval_list sensor_2880x1620_30fps_shdr_4lan_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct regval_list sensor_2880x1620_20fps_shdr_4lan_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct regval_list sensor_2880x1620_15fps_shdr_4lan_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static int sensor_g_fps(struct v4l2_subdev *sd, struct sensor_fps *fps)
{
	...
	sensor_read(sd_temp, 0x320e, &frame_length);
	act_vts = frame_length << 8;
	sensor_read(sd_temp, 0x320f, &frame_length);
...
static struct sensor_win_size sensor_win_sizes[] = {
	{
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_15fps_2lan_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_15fps_2lan_regs),
		.set_size = NULL,
	},
	{
		.width = 2880,
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_30fps_4lan_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_30fps_4lan_regs),
		.set_size = NULL,
	},

	{
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_20fps_4lan_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_20fps_4lan_regs),
		.set_size = NULL,
	},
	/*vb:1650-1620 = 30,must set vb > 36 otherwise isp cannot set*/
	{
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_60fps_4lane_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_60fps_4lane_regs),
		.set_size = NULL,
	},

	{
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_30fps_shdr_4lan_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_30fps_shdr_4lan_regs),
		.set_size = NULL,
	},

	{
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_20fps_shdr_4lan_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_20fps_shdr_4lan_regs),
		.set_size = NULL,
	},

	{
		...
		.gain_min = 1 << 4,
		.gain_max = 326 << 4,
		.regs = sensor_2880x1620_15fps_shdr_4lan_regs,
		.regs_size = ARRAY_SIZE(sensor_2880x1620_15fps_shdr_4lan_regs),
		.set_size = NULL,
	},
};
...
#endif
{
	...
	sensor_dbg("sensor sc530ai probe\n");
