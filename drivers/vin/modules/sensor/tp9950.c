				...
				struct v4l2_mbus_config *cfg)
{
	...
	cfg->bus.parallel.flags = CLK_POL | CSI_CH_0;
#else
...
#else
	sensor_indetect.detect_power.gpio = of_get_named_gpio(
	    np, "gpio_power", 0);
	sensor_indetect.detect_gpio.gpio = of_get_named_gpio(
	    np, "gpio_detect", 0);
...
#else
	sensor_indetect.sensor_class = class_create("csi");
#endif
